...
class RabbitMQClient {
    ...
    async initialize(){
        ...
        try{
            ...
            await this.produceChannel.assertQueue(RabbitMQConfig.rabbitMQ.queues.paymentQueue,{durable:true})
            await this.consumerChannel.assertQueue(RabbitMQConfig.rabbitMQ.queues.paymentQueue,{durable:true})
