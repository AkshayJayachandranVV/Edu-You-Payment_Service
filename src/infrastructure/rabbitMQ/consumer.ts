...
export default class Consumer{
    ...
    async consumeMessage(){
        try{
            ...
            await this.channel.assertQueue(RabbitMQConfig.rabbitMQ.queues.paymentQueue,{durable:true})
            this.channel.consume(RabbitMQConfig.rabbitMQ.queues.paymentQueue,async(message:ConsumeMessage | null)=>{
                if(message){
